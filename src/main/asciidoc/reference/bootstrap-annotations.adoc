...
in your _Maven_ `pom.xml` or `build.gradle` file when using _Gradle_.  This is only necessary if you use Apache Geode's
...
http://geode.apache.org/releases/latest/javadoc/org/apache/geode/compression/Compressor.html[`Compressors`] to adapt
