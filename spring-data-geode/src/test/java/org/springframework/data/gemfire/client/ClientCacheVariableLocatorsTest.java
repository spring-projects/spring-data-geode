...
public class ClientCacheVariableLocatorsTest extends ForkingClientServerIntegrationTestsSupport {
	...
	public static void setup() throws IOException {
		...
		arguments.add("/org/springframework/data/gemfire/client/ClientCacheVariableLocatorsTest-server-context.xml");
