...
/**
 * Tests for {@link AsRegionEventHandler} configured for a
 * {@link org.apache.geode.cache.server.CacheServer} to process all {@link RegionEvent}
 *
 ...
 * @since 2.3.0
 */
public class AsRegionEventClientCacheConfigurationTests extends AsRegionEventConfigurationTests {
	...
	protected Class<?> getRegionClearWithBothWriterAndListenerConfiguration() {
		return TestConfigurationForWithBothListenerAndWriterSingleHandler.class;
	}

	@Override
	protected Class<?> getRegionClearWithNoEventHandlersConfiguration() {
		return TestConfigurationForWithNoEventHandlers.class;
	}
	...
	public static class TestConfigurationForWithBothListenerAndWriterSingleHandler {
		...
		@AsRegionEventHandler(regionWriterEventTypes = RegionCacheWriterEventType.BEFORE_REGION_CLEAR, regionListenerEventTypes = RegionCacheListenerEventType.AFTER_REGION_CLEAR)
